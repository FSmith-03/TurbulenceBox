...
def solver():
    ...
    u_total, v_total, w_total = pv.total_velocities_parallel(Nx, x_boundary, N_E, theta_list, a_list)
    ...
    r, f, g, f_s, max_index_plot = cf.correlation_functions_vect(u_total, v_total, tol, plot_limit, u_2_average)
